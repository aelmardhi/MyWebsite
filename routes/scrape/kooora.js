...
async function tryLoad(timezone){
    ...
    try{
        ...
        // browser.close()
        let result = {...main, barca,baseUrl:'https://clm.kooora.com/default.aspx',time:  Date()}
        cache = result;
...
async function updateNews(page,timezone,urlQuery){
    try{
        ...
        await page.goto('https://clm.kooora.com/default.aspx'+urlQuery,{timeout:300000, waitUntil:"domcontentloaded"});
...
async function getKooraHome(browser,timezone){
    try{
        const page = await browser.newPage()
        page.emulateTimezone(timezone)
        await page.goto('https://clm.kooora.com/default.aspx',{timeout:300000, waitUntil:"domcontentloaded"})
...
async function getKooraTeamImportant (browser,timezone, team){
    try{
        const page = await browser.newPage()
        page.emulateTimezone(timezone)
        await page.goto('https://clm.kooora.com/default.aspx?team='+team,{timeout:300000, waitUntil:"domcontentloaded"})
